...
component App() {
    ...
    let bottom_panel_visible = signal(true);
    ...
    render {
        <div class="app-container" style={styles::ide_layout()}>
            ...
            <ActivityBar
                ...
                on_change={Callback::new(|new_route| route.set(new_route))}
            />
            ...
            <div class="main-area">
                ...
                <main class="content">
                    @match route.get() {
                        Route::Navigation => {
                            <NavigationDesignerPage store={store.clone()} />
                        }
                        Route::CssDesigner => {
                            <CssDesignerPage store={store.clone()} />
                        }
                        Route::Settings => {
                            <SettingsPage store={store.clone()} />
                        }
                    }
                </main>
